...
function getFlavorByIndex(originalFlavors, ind){
    console.log("Our special of the day is half off on any size", originalFlavors[ind], ", and you still get a punch on your free ice cream card!")
}
getFlavorByIndex(originalFlavors, 19);
...
function biBo(ogFlavors, originalFlavors){
    ogFlavors = [...originalFlavors];
    console.log(ogFlavors);
}
var ogFlavors = [ ]
biBo(ogFlavors, originalFlavors);
